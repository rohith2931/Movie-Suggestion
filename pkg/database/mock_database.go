...
import (
	schema "example/movieSuggestion/pkg/schema"
	reflect "reflect"
...
func (m *MockDatabase) AddMovie(arg0 *schema.Movie) error {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) CreateLike(arg0, arg1 uint64) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) CreateReview(arg0 *schema.Review) error {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) CreateUser(arg0 *schema.User) error {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) DeleteLike(arg0, arg1 uint64) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) GetAllWatchlistMovies(arg0 uint64) ([]schema.Movie, error) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) UpdateReview(arg0 uint64, arg1 schema.Review) error {
	m.ctrl.T.Helper()
